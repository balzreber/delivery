...
@section('content')
	...
	{{ Form::model($batch, array('method' => 'PATCH', 'route' => array('batch.update', $batch->id), 'class' => 'pure-form pure-form-aligned')) }}
	...
	<fieldset>
		...
		<div class="pure-control-group">
			{{ Form::label('formatedDate', 'Delivery Date') }}
			{{ Form::text('formatedDate', Input::old('formatedDate'), array('class' => 'pure-input-1-3', 'placeholder' => 'Delivery Date')) }}
			{{ $errors->first('formatedDate', '<span class="error">:message</span>') }}
		</div>
